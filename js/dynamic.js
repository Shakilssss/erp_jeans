...
function empty()
{
 ...
 function earn_leave_process(){
   ...
   year= document.getElementById('report_year_sal').value;
	...
	url =  "http://"+hostname+"/erp_jeans/index.php/salary_process_con/earn_process_new/";
...
hostname = window.location.hostname;
document.image.src = "http://"+hostname+"/erp_jeans/uploads/photo/"+img;
...
function com_info_Search1()
{
 ...
 var queryString="empid="+empid;
 hostname = window.location.hostname;
 var url = "http://"+hostname+"/erp_jeans/index.php/emp_info_con/com_info_search1/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
      ...
      document.cominfo.mobile.value = otherinfo[17];
		var img = otherinfo[18];
		hostname = window.location.hostname;
		document.image.src = "http://"+hostname+"/erp_jeans/uploads/photo/"+img;
		document.image.height = 150;
		document.image.width = 120;
		
		document.cominfo.bname.value = otherinfo[19];
		document.cominfo.id_skill.value = otherinfo[20];
		
		document.cominfo.pre_add_bn.value = otherinfo[21];
      document.cominfo.per_add_bn.value = otherinfo[22];
      document.cominfo.nid.value = otherinfo[23];
      document.cominfo.bank_acc.value = otherinfo[24];
...
function com_info_next_Search1()
{
 ...
 hostname = window.location.hostname;
 var url = "http://"+hostname+"/erp_jeans/index.php/emp_info_con/com_info_next_Search1/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.cominfo.pre_add_bn.value = otherinfo[20];
        document.cominfo.per_add_bn.value = otherinfo[21];
        document.cominfo.nid.value = otherinfo[22];
...
function com_info_prev_Search1()
{
 ...
 var queryString="id_skill="+id_skill;
 hostname = window.location.hostname;
 var url = "http://"+hostname+"/erp_jeans/index.php/emp_info_con/com_info_prev_Search1/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
if(okyes==false) return;
	  $("#loader").show();
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_jeans/index.php/attn_process_con/attn_process/";
...
// alert('Hi');return;
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_jeans/index.php/salary_process_con/salary_process/";
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/erp_jeans/index.php/entry_system_con/save_leave_co/";
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/erp_jeans/index.php/entry_system_con/leave_transaction_co/";
...
hostname = window.location.hostname;
url =  "http://"+hostname+"/erp_jeans/index.php/entry_system_con/advance_loan_insert/";
...
function find_style_winding()
{
 ...
 //alert(queryString);
 url =  "http://"+hostname+"/erp_jeans/index.php/winding_con/find_style_name_winding/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
function find_style_knitting()
{
 ...
 try{
  ...
  var queryString="article_name="+article_name;
 //alert(queryString);
 url =  "http://"+hostname+"/erp_jeans/index.php/knitting_con/find_style_name_knitting/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
function find_style_linking()
{
 ...
 //alert(queryString);
 hostname = window.location.hostname;
 url =  "http://"+hostname+"/erp_jeans/index.php/linking_con/find_style_name_linking/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
function find_style_trimming()
{
 ...
 try{
  ...
  var queryString="article_name="+article_name;
 //alert(queryString);
 url =  "http://"+hostname+"/erp_jeans/index.php/trimming_con/find_style_name_trimming/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
function find_style_mending()
{
 ...
 try{
  ...
  var queryString="article_name="+article_name;
 //alert(queryString);
 url =  "http://"+hostname+"/erp_jeans/index.php/mending_con/find_style_name_mending/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
function find_style_zipper()
{
 ...
 try{
  ...
  var queryString="article_name="+article_name;
 //alert(queryString);
 url =  "http://"+hostname+"/erp_jeans/index.php/zipper_con/find_style_name_zipper/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
function find_style_iron()
{
 ...
 try{
  ...
  var queryString="article_name="+article_name;
 //alert(queryString);
 url =  "http://"+hostname+"/erp_jeans/index.php/iron_con/find_style_name_iron/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
//	alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/winding_con/price_code_winding_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
//	alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/mending_con/price_code_mending_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_save_zipper()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name+"&style_type_id="+style_type_id+"&style_price="+style_price;
//	alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/zipper_con/price_code_zipper_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_save_iron()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name+"&style_type_id="+style_type_id+"&style_price="+style_price;
//	alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/iron_con/price_code_iron_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_save_trimming()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name+"&style_type_id="+style_type_id+"&style_price="+style_price;
//	alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/trimming_con/price_code_trimming_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_knitting_save()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name+"&style_type_id="+style_type_id+"&style_price="+style_price;
//	alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/knitting_con/price_code_knitting_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table_winding()
{
 ...
 try{
   ...
   try{
	...
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/winding_con/show_table_winding/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table_mending()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/mending_con/show_table_mending/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table_zipper()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/zipper_con/show_table_zipper/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table_iron()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/iron_con/show_table_iron/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table_trimming()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/trimming_con/show_table_trimming/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table_knitting()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/knitting_con/show_table_knitting/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_edit_mending(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/mending_con/style_type_price_edit_mending/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_edit_winding(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/winding_con/style_type_perice_edit_winding/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_edit_zipper(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/zipper_con/style_type_price_edit_zipper/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_edit_iron(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/iron_con/style_type_price_edit_iron/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_edit_trimming(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/product_con/style_type_perice_edit_trimming/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_edit_knitting(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/knitting_con/style_type_price_edit_knitting/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_edit_trimming(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/trimming_con/style_type_price_edit_trimming/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_delete_mending(i)
{
 ...
 try{
   ...
   try{
	...
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/mending_con/price_code_delete_mending/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_delete_winding(i)
{
 ...
 try{
   ...
   try{
	...
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/winding_con/price_code_delete_winding/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_delete_zipper(i)
{
 ...
 try{
   ...
   try{
	...
	var queryString="i="+i+"&article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/zipper_con/price_code_delete_zipper/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_delete_iron(i)
{
 ...
 try{
   ...
   try{
	...
	var queryString="i="+i+"&article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/iron_con/price_code_delete_iron/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_delete_trimming(i)
{
 ...
 try{
   ...
   try{
	...
	var queryString="i="+i+"&article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/product_con/style_type_perice_delete_trimming/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_delete_knitting(i)
{
 ...
 article_name =   document.getElementById("article_name").value ;
	...
	url="http://"+hostname+"/erp_jeans/index.php/knitting_con/price_code_delete_knitting/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_delete_trimming(i)
{
 ...
 article_name =   document.getElementById("article_name").value ;
	...
	url="http://"+hostname+"/erp_jeans/index.php/trimming_con/price_code_delete_trimming/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_update_mending(i)
{
 ...
 try{
   ...
   try{
	...
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/mending_con/price_code_update_mending/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_update_winding(i)
{
 ...
 try{
   ...
   try{
	...
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/winding_con/price_code_update_winding/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_update_zipper(i)
{
 ...
 try{
   ...
   try{
	...
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/zipper_con/price_code_update_zipper/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_update_iron(i)
{
 ...
 try{
   ...
   try{
	...
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/iron_con/price_code_update_iron/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_update_trimming(i)
{
 ...
 try{
   ...
   try{
	...
	var queryString="i="+i+"&get_style_price="+get_style_price;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/product_con/style_type_perice_update_trimming/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_update_knitting(i)
{
 ...
 try{
   ...
   try{
	...
	var queryString="i="+i+"&get_style_price="+get_style_price+"&article_name="+article_name+"&style_name="+style_name ;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/knitting_con/price_code_update_knitting/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_update_trimming(i)
{
 ...
 try{
   ...
   try{
	...
	var queryString="i="+i+"&get_style_price="+get_style_price+"&article_name="+article_name+"&style_name="+style_name ;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/trimming_con/price_code_update_trimming/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_save_linking()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name+"&style_type_id="+style_type_id+"&style_price="+style_price;
//	alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/linking_con/price_code_linking_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_linking_edit(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/linking_con/style_type_price_linking_edit/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_linking_update(i)
{
 ...
 try{
   ...
   try{
	...
	var queryString="i="+i+"&get_style_price="+get_style_price+"&article_name="+article_name+"&style_name="+style_name ;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/linking_con/style_type_price_linking_update/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_linking_delete(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/product_con/style_type_perice_linking_delete/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table_linking()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp_jeans/index.php/linking_con/show_table_linking_co/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
var ajaxRequest;  // The variable that makes Ajax possible!
 ...
 //alert(queryString);
 hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_jeans/index.php/product_con/bdt_save_co/";
	ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
function com_incre_prom_search()
{
 ...
 var queryString="empid="+empid;
 hostname = window.location.hostname;
 var url = "http://"+hostname+"/erp_jeans/index.php/emp_increment_con/com_incre_prom_search/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
