...
<body>
<div align="center" style=" margin:0 auto;width:1000px; overflow:hidden; font-family: 'Times New Roman', Times, serif;">
<?php 
...
for($i=0; $i<$count; $i++ )
{
	...
	echo "<td width='140' style='background:#DDDDDD;'> ";
	...
	echo "<td width='140'  style='text-align:center;' >";
	echo $sStartDate;
	echo "</td>";
	echo "</tr>";
