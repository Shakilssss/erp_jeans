...
<div style="width:800px;margin-bottom:8px; height:360px; border:1px  dashed; padding-top:4px;">
  ...
  <div style="width:25%; float:left; border-right:1px dashed; ">
      ...
      <tr>
        <td>Join Date</td><td><?php $doj = $this->db->select('emp_join_date')->where('emp_id',$rows["emp_id"])->get('pr_emp_com_info')->row()->emp_join_date; echo date('d-M-Y', strtotime($doj));   ?></td></tr>
  ...
  <div style="width:74%;float:right;">
	...
	<?php echo $company_name_english = $this->common_model->company_information("company_name_bangla"); ?><br />Section : 
	<?php echo $rows["sec_name"];   ?>&nbsp;&nbsp;Print Date: <?php echo date("Y.m.d");   ?>
    </div> 
    <div>
      ...
      <td>DOJ :</td><td><?php echo date('d-M-Y', strtotime($doj));?></td>
      </tr>
      </table>
      </div><br />
    <div style="float:left; width:30%;">
      ...
      <tr>
          <td rowspan="3">Leave Status</td><td>নৈমিত্তিক ছুটি:</td>
          <td style="font-family: SutonnyMJ; text-align:center;"><?php echo $rows["c_l"]; ?></td>
      </tr>
      <tr>
      	   <td>অসুস্থ্য ছুটি:</td><td style="font-family: SutonnyMJ; text-align:center;"><?php echo $rows["s_l"]; ?></td>
      </tr>
      <tr>
      	   <td>অর্জিত ছুটি:</td><td style="font-family: SutonnyMJ; text-align:center;"><?php echo $rows["e_l"]; ?></td>
      </tr>
      <tr><td>Absent Days </td><td>অনুপস্থিত:</td><td style="font-family: SutonnyMJ; text-align:center;"><?php echo $rows["absent_days"];   ?></td></tr>
      <tr><td>After/Before Absent Days</td><td>পূর্বে/পরে অনুপস্থিত:</td><td style="font-family: SutonnyMJ; text-align:center;"><?php echo $rows["before_after_absent"];   ?></td></tr>
      </table>
    </div>
    <div style="float:left; width:30%;">
      <table align="left" border="1" cellpadding="1" cellspacing="0" style=" width:98%;height:260px;font-size:10px; border-collapse:collapse;">
    ...
    <div style="float:left; width:38%;">
      ...
      <tr><td>Total</td><td>মোট </td><td></td><td style="font-family: SutonnyMJ; text-align:right;"><?php echo  $total_days = $rows["pay_wages"] + $rows["ot_amount"] + $rows["att_bonus"] - $rows["deduct_amount"] -10;  ?></td></tr>
      </table>
    </div>
    <div style="font-weight:bold; font-size:12px;">Calculation of Over Time : (Basic x 2) ÷ 208 x Total O.T. Hour
