...
<table cellpadding="0" cellspacing="5" width='900px' border='0' align='center'>
<tr>
  <td>Emp Id </td>
...
<tr><td>Pre.Add.BN</td>
<td><input type='text' style="width:170px;" id='pre_add_bn' name='pre_add_bn' value="<?php echo set_value('pre_add_bn'); ?>"></td>
<td>Per.Add.BN</td>
<td><input type='text' style="width:170px;" id='per_add_bn' name='per_add_bn' value="<?php echo set_value('per_add_bn'); ?>"></td>
</tr>
...
<td>Mobile</td>
<td><input type='text' style="width:170px;" id='mobile' name='mobile' value="<?php echo set_value('mobile'); ?>"></td>
...
<tr><td>Emp Shift</td><td>
	...
	<td>Bank Account</td>
	<td>
		<input type='text' style="width:170px;" id='bank_acc' name='bank_acc' value="<?php echo set_value('bank_acc'); ?>">
	</td>
<!--   <td>Lunch Entitle</td>
<td>
...
<tr>
  ...
  <td class="salary_back"><input name="text8" type='text' id='gsal'  onchange='basic_sal_cal()'  value="<?php echo set_value('text8'); ?>" required autocomplete="off" style="width:170px;" style="background: #DDD;font-weight:bold;"/></td>
...
<input type="text" name="id_skill" id="id_skill" value="<?php echo set_value('id_skill'); ?>"   />
