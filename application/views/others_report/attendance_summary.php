...

{
	...
	$total_leave = $total_leave + $values["daily_att_sum_male"][$i]['all_leave'] + $values["daily_att_sum_female"][$i]['all_leave'];
	$total_leave_prev = $total_leave_prev + $prev_values["daily_att_sum_male"][$i]['all_leave'] + $prev_values["daily_att_sum_female"][$i]['all_leave'];
 ...
 <div style="margin-left: 320px;">
  ...
  <table class="sal" border="1" cellpadding="1" cellspacing="0" align="center" style="font-size:15px;margin-left: 50px; float: left;">
  	<thead>
  		...
  		<th colspan="5">Previous Day's Employees</th>
  		</tr>
  	</thead>
  	<tbody>
  		<tr style="font-weight:bold; text-align:center;">
  		...
  		<tr>
  			...
  			<td><?php echo $total_leave_prev;?></td>
  ...
  <table class="sal" border="1" cellpadding="1" cellspacing="0" align="center" style="font-size:15px;margin-left: 50px; float: left;">
  	<thead>
  		<tr class="sal" border="1" cellpadding="1" cellspacing="0" align="center" style="font-size:15px;margin-left: 12px;background: rgb(193, 224, 255) none repeat scroll 0% 0%;">
  		<th colspan="5">Today's Total Employees</th>
  		</tr>
  	</thead>
  	<tbody>
  		<tr style="font-weight:bold; text-align:center;">
  		...
  		<tr>
  			...
  			<td align="right"><?php echo $total_leave; ?></td>
  ...
  <table class="sal" border="1" cellpadding="1" cellspacing="0" align="center" style="font-size:15px;margin-left: 50px; float: left;">
  	...
  	<tbody>
  		...
  		<tr>
  			<td>Leave</td>
			<td><?php $percent_leave = ($total_leave/$all_emp_male_female)*100; echo round($percent_leave)."%";?></td>
  			<td align="right"><?php echo $total_leave;?></td>
  		</tr>
  	</tbody>
  </table>
