...
<fieldset style='width:95%;'><legend><font size='+1'><b>Daily Reports</b></font></legend>
	<table width="100%"  style="font-size:11px; ">
		<tr>
			...
			<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="New Attendance Summary" onClick="new_daily_attendance_summary()"></td>
			<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="New OT Summary" onClick="new_daily_ot_summary()"></td>

			<?php
			$user_id = $this->acl_model->get_user_id($this->session->userdata('username'));
			$acl     = $this->acl_model->get_acl_list($user_id);
			if(!in_array(10,$acl)){?>
				<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="Ot & Eot Summary" onClick="daily_ot_eot_summary()"></td>
			<?php }?>
			<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="Daily Line Cost Summary" onClick="daily_line_cost_summary()"></td>
