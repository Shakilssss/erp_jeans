...

{
	...
	$total_line_helper_male_female = $total_line_helper_male_female + $values["daily_att_sum_male"][$i]['all_emp'] + $values["daily_att_sum_female"][$i]['all_emp'];
	}
	//=========================END Helper========================
	...
	$total_line_staff_male_female = $total_line_staff_male_female + $values["daily_att_sum_male"][$i]['all_emp'] + $values["daily_att_sum_female"][$i]['all_emp'];
	}
	//=========================Staff========================
	...
	$total_line_qc_male_female = $total_line_qc_male_female + $values["daily_att_sum_male"][$i]['all_emp'] + $values["daily_att_sum_female"][$i]['all_emp'];
	}
	//=========================END QC========================
  ...
  <table class="sal" border="1" cellpadding="1" cellspacing="0" align="center" style="font-size:15px;margin-left: 20px; float: left;">
  	...
  	<tbody>
  		...
  		<tr>
  			<td>Operator</td>
  			<td align="right"><??></td>
  			<td align="right"><?php echo $all_line_operator_present_male_female;?></td>
  		</tr>
  		<tr>
  			<td>Helper</td>
  			<td align="right"><??></td>
  			<td align="right"><?php echo $all_line_helper_present_male_female;?></td>
  		</tr>
  		<tr>
  			<td>QC</td>
  			<td align="right"><??></td>
  			<td align="right"><?php echo $all_line_qc_present_male_female;?></td>
  		</tr>
  		<tr>
  			<td>Staff</td>
  			<td align="right"><??></td>
  			<td align="right"><?php echo $all_line_staff_present_male_female;?></td>
  		</tr>
  	</tbody>
  </table>
  ...
  <table class="sal" border="1" cellpadding="1" cellspacing="0" align="center" style="font-size:15px;margin-left: 50px; float: left;">
  	...
  	<tbody>
  		...
  		<tr>
  			...
  			<td align="right"><?php echo $ttl_present_emp = $all_present_male_female + $all_absent_male_female;?></td>
  		</tr>
  	</tbody>
  </table>
  <table class="sal" border="1" cellpadding="1" cellspacing="0" align="center" style="font-size:15px;margin-left: 50px; float: left;">
  	...
  	<tbody>
  		<tr>
  			<td>Present</td>
  			<td><?php $percent_present_emp = ($all_present_male_female/$all_emp_male_female)*100; echo round($percent_present_emp)."%";?></td>
  			<td align="right"><?php echo $all_present_male_female;?></td>
  		</tr>
  		<tr>
  			<td>Absent</td>
