...
?>
  ...
  <tr height="10px">
    ...
    <td width="15" style="font-size:8px;"><div align="center"><strong>Gross</strong></div></td>
  	...
  	<td width="15" style="font-size:8px;"><div align="center"><strong>HF Days</strong></div></td>
...
<?php
	...
	for($p=0; $p<=$per_page_row;$p++)
	{
		...
		$grand_total_pay_wages = $grand_total_pay_wages + $value[$k]->pay_wages;
	...
	if($counter == $page)
   		{?>
            ...
            <td colspan="12"></td>
            <td align="right"><strong><?php echo $english_format_number = number_format($grand_total_pay_wages);?></strong></td>
