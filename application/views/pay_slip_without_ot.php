 ...
 <?php $this->load->view('head_bangla'); ?>
  ...
  <div style="width:300px; height:auto; overflow:hidden; border:1px solid #000000;">
	...
	<table width="300" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td width="75"><font style="font-family: SutonnyMJ;">: <?php echo $total_days = 0;   ?> </font> </td>
		</tr>
		<tr>
  ...
  <div style="width:100%; border-bottom:1px solid #000000; height:auto; overflow:hidden;">
    ...
    <tr>
	  ...
	  <span style="font-family: SutonnyMJ; " > 0 </span>
	  </td>
    </tr></table></div>
    ...
    <tr>
      ...
      <td width="43"><font style="font-family: SutonnyMJ;" > <?php echo $total_days = $rows["gross_pay"]-$rows["ot_amount"];   ?> </font></td>
    </tr></table></div>
    ...
    <tr>
      ...
      <td >:</td>
	  <td width="78" align="center"> <font style="font-family: SutonnyMJ;" > <?php echo $total_days = $rows["net_pay"]-$rows["ot_amount"]-$stamp_value;   ?> </font></td>
    </tr></table></div>
  </div>
