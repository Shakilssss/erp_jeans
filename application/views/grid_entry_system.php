...
<br>
<div style="margin:0 auto; width:48%; overflow:hidden; float:left;">
	<fieldset style="width:90%;"><legend><font size="+1"><b>Lunch Leave</b></font></legend>
		<form name='manual_attendance'>
			<table>
				<tr><td>Time </td><td>:</td><td><input type='text' name='lunch_leave' id='lunch_leave' size='16'></td>
				<td><input type='button' name='btn' id='btn' onclick='manual_lunch_leave_entry()' value='Insert' size='12'></td></tr>
				<tr><td></td><td></td><td> <span style="font-size:12px;"> [HH:MM:SS]</span></td></tr>
			</table>
		</form>
	</fieldset>
...
<div style="margin:0 auto; width:48%; overflow:hidden; float:right;">
	<fieldset style='width:90%;'><legend><font size='+1'><b>Lunch Leave Delete</b></font></legend>
		<form name='present_absent'>
			<table>
				<tr><td><input type='button' onclick='manual_lunch_leave_entry_delete()' value='Delete'/></td></tr>
				<tr><td><span style="font-size:12px;">[Select First & Second date and employee ID]</span></td></tr>
			</table>
		</form>
	</fieldset>
