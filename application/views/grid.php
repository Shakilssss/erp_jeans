...
<td style="width:20%; background-color: #666666;"><input type="button" style="width:100%; font-size:100%;" value="Daily Out Time Summary" onClick="grid_out_time_summary_report()"></td>
</tr>
<tr>
	<td style="width:20%; background-color: #666666;"><input type="button" style="width:100%; font-size:100%;" value="Daily EOT After 12 AM" onClick="grid_daily_eot_after_12_am()"></td>
	<td style="width:20%; background-color: #666666;"><input type="button" style="width:100%; font-size:100%;" value="Tiffin Bill After 12 AM" onClick="tiffin_bill_after_12_am()"></td>
	<td style="width:20%; background-color: #666666;"><input type="button" style="width:100%; font-size:100%;" value="Tiffin Bill 10.20pm to 12AM" onClick="tiffin_bill_10pm_to_12am()"></td>
</tr>
<?php } ?>
</table>
...
<td style="width:20%;"><input type="button" style=" width:100%; font-size:100%;"  value="Incomplate Month Salary" onClick="incomplate_month_salary()"></td>
</tr>
</table>
...
<tr>
	<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="Job Card Without OT" onClick="grid_job_card_without_ot()"></td>
<?php
$user_id = $this->acl_model->get_user_id($this->session->userdata('username'));
$acl     = $this->acl_model->get_acl_list($user_id);
if(!in_array(10,$acl))
{
?>
	<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="Yearly Leave Report" onClick="grid_yearly_leave_report()"></td>
<?php } ?>
	<td style="width:20%;">
		<?php
		$user_id = $this->acl_model->get_user_id($this->session->userdata('username'));
		$acl     = $this->acl_model->get_acl_list($user_id);
		if(!in_array(10,$acl)) { ?>
			<input type="button" style="width:100%; font-size:100%;" value="EOT Job Card 10pm" onClick="grid_extra_ot_10pm()">
		<?php } ?>
	</td>
...
<tr>
<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="NOC Letter" onClick="grid_noc_letter('1')"></td>
<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="NOC Letter 2nd" onClick="grid_noc_letter('2')"></td>
<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="NOC Letter 3rd" onClick="grid_noc_letter('3')"></td>

<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="Age Estimation" onClick="grid_age_estimation()"></td>
<!-- <td style="width:20%;"></td> -->
</tr>


<tr>
<!-- <td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="Appoinment Letter" onClick="grid_app_letter()"></td> -->
<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="Application" onClick="grid_application()"></td>
<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="Nominee Form" onClick="grid_nominee_form()"></td>

<td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="Leave Register" onClick="leave_register()"></td>
<!-- <td style="width:20%;"></td> -->
</tr>
...
<div id="viewid"></div>
	<div class="clearfix" style="display:none;">
		<div class="loading"><img src="<?php echo base_url() ?>img/load1.gif"  alt="Load"/></div>
