...
<div style="width:8in; height:11.5in; overflow:hidden;">
	...
	for($k; $i <= $end; $i++)
	{
	  ...
	  <div id="container">
		 ...
		 <div id="text">
		 <div class="vText">
		   <p style="text-align:center;">~: যোগাযোগের ঠিকানা :~</p>
		   <p style="font-weight:bold;">জিন্স ম্যানুফ্যাকচারিং কোঃ লিমিটেড </p>
		   <p>১৩-১৪, চিড়িয়াখানা রোড, মল্লিক টাওয়ার</p>
		   <p>মিরপুর - ১, ঢাকা - ১২১৬।</p>
		   <p>ফোন:  ৮৮-০২-৯০০৭৭১৯, ৮৮-০২-৯০০৭৭৪২ </p>
		   </div>
		 </div>
		 ...
		 <div id="id" align="center">	
		  ...
		  <div id="logo"> 
			<img src="<?php  echo base_url();?>images/logo.gif" width="100" alt="LOGO" /><br />
			<!--<img src="<?php  echo base_url();?>images/company_name.jpg" height="15" width="160" /><br />-->
			<div style=" margin:0 auto; width:100%; height:auto;font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold;">জিন্স ম্যানুফ্যাকচারিং কোঃ লিমিটেড 
			</div>
		  </div>
		  <div id="image"  >
		  ...
		  <td><b>&#2453;&#2494;&#2480;&#2509;&#2465; &#2472;&#2434;</b> </td><td>:</td><td> <?php echo $data[$i]["emp_id"] ?></td></tr>
			...
			<tr><td colspan="3"><b>&#2479;&#2507;&#2455;&#2470;&#2494;&#2472;&#2503;&#2480; &#2468;&#2494;&#2434;</b> : <span class="bijoy"><?php 
				...
				?></span>	</td></tr>
            <tr><td><b>জন্ম তারিখ</b> </td><td>:</td><td> <span class="bijoy"><?php 
					$dob = $data[$i]["emp_dob"]; 
					$year=trim(substr($dob,0,4));
					$month=trim(substr($dob,5,2));
					$day=trim(substr($dob,8,2));
					echo " ".$date_format = date("d-m-y", mktime(0, 0, 0, $month, $day, $year));
				?></span>	</td></tr>
				<br/><br/><br/><br/><br/>
				</table>
		  ...
		  <div id="sign"> 
			<span style="position:relative; right:16px;"><img src="<?php echo base_url();?>images/signature.png" width="100" height="auto" /></span>
