...
<table class="sal" border="1" cellspacing="0" cellpadding="0" style="font-size:13px;">
  ...
  <tr >
    ...
    <td width="14"><div align="center"><strong>Proxi ID</strong></div></td>
    <td width="47"><div align="center"><strong>Name</strong></div></td>
     <td width="47"><div align="center"><strong>Gender</strong></div></td>
    ...
    <td width="19"><div align="center"><strong>DOB</strong></div></td>
	...
	<td width="35"><div align="center"><strong>Mobile</strong></div></td>
	<td width="35"><div align="center"><strong>NID</strong></div></td>
...
<?php
			...
			foreach($value as $row)
			{
				...
				echo "<td style='text-align:center;'>";
				$emp_dob = $row->emp_dob;
				$year=trim(substr($emp_dob,0,4));
				$month=trim(substr($emp_dob,5,2));
				$day=trim(substr($emp_dob,8,2));
