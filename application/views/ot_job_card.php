		...
		<div align="center" style="height:100%; width:100%; overflow:hidden;" >
			<?php
				...
				foreach ($values as $key => $value) { 
					...
					echo "<table class='sal' border='1' bordercolor='#000000' cellspacing='0' cellpadding='0' style='text-align:center; font-size:13px; '> <th>Date</th><th>In Time</th><th>Out Time</th><th>Attn.Status</th><th>OT Hour</th><th>Extra OT Hour</th><th>Remarks</th>";

					foreach ($emp_data['emp_data'] as $key => $row) {

						if('0.0' == $row->extra_ot_hour) {
							$extra_ot_hour = '';
						} else {
