...
<!-- <td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="NOC Letter" onClick="grid_earn_leave()"></td> -->
...
<!-- <td style="width:20%;"><input type="button" style="width:100%; font-size:100%;" value="Job Card" onClick="grid_advance_job_card()"></td> -->
<!-- <td style="width:20%;"></td> -->
</tr>
</table>
