 	...
 	<?php
		...
		foreach ($values as $row){
			...
			if ($row["daily_out_time"][0]['totalemp'] !=0) {
				...
				echo "<td align='center'>";
				echo number_format($row["daily_out_time"][0]['slot_11']);
				$elevenp = $elevenp + number_format($row["daily_out_time"][0]['slot_11']);

				// $s_total=$row["daily_out_time"][0]['t_wages']+$row["daily_out_time"][0]['t_bonus']+$row["daily_out_time"][0]['t_ot_amt'];
				// echo number_format($s_total);
				echo "</td>";

				echo "<td align='center'>";
				echo number_format($row["daily_out_time"][0]['slot_12'] + $row["daily_out_time"][0]['slot_12e']);
				$twelvep = $twelvep + $row["daily_out_time"][0]['slot_12']+$row["daily_out_time"][0]['slot_12e'];
